...
void flowAnalysis(){
     ...
     Int_t nParticle, iParticle, cent;
     Float_t phi[20000];
     Float_t pt[20000];
     Float_t eta[20000];
     ...
     const int NB_SLICE_PT = 3;
     double minPtCut[NB_SLICE_PT] = {0.2,10,100};
     double maxPtCut[NB_SLICE_PT] = {10,100,1000}; //15 bins
     ...
     t1.Add("slurm_total_centrality.root");
     t1.SetBranchAddress("centralityBinTree", &cent);
